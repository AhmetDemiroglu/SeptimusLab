...
const html = String.raw`<div class="marquee-wrapper" aria-label="Marka ve teknoloji bantı">
        <div class="marquee-track">
            ...
            <div class="marquee-item">
                <img src="/assets/fintel.webp" alt="Fintel">
                <span>Fintel</span>
            </div>
            <div class="marquee-item">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="color: #34A853;">
