        ...
        <div class="container hero-layout">
            <div class="hero-copy">
                ...
                <div class="hero-actions reveal reveal-delay-3">
                    ...
                    <a href="https://apps.apple.com/us/developer/ahmet-demiroglu10461503141/id6778348939" target="_blank" rel="noopener noreferrer" class="store-btn" aria-label="SeptimusLab App Store geliştirici sayfası">
                        <svg class="store-glyph" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
