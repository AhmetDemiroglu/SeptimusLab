  ...
  "@graph": [
    {
      ...
      description:
        "İzmir merkezli bağımsız mobil yazılım stüdyosu. AI destekli mobil uygulamalar geliştiriyoruz.",
      foundingDate: "2025",
      foundingLocation: {
        "@type": "Place",
        name: "İzmir, Turkey",
      ...
      sameAs: [
        "https://play.google.com/store/apps/developer?id=SeptimusLab",
        "https://www.instagram.com/septimus.lab/",
      ],
      contactPoint: {
        "@type": "ContactPoint",
    ...
    },
    {
      ...
      description:
        "AI destekli mobil uygulamalar geliştiren İzmir merkezli yazılım stüdyosu",
    ...
    },
    {
      ...
      installUrl:
        "https://play.google.com/store/apps/details?id=com.septimuslab.purescan",
    ...
    },
    {
      ...
      installUrl:
        "https://play.google.com/store/apps/details?id=com.fintel.app",
      author: { "@id": `${siteUrl}/#organization` },
...
export const metadata = {
  ...
  openGraph: {
    ...
    title:
      "SeptimusLab - Mobil Uygulama Geliştirme | AI Destekli Android Uygulamalar",
    description:
  ...
  twitter: {
    ...
    description:
      "Kozmetik analizi (PureScan) ve akıllı bütçe yönetimi (Fintel). İzmir merkezli yapay zeka destekli Android uygulama stüdyosu.",
  ...
  return (
    <html lang="tr">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-G5RB1ESJLY"
        />
        <script
